...
class Accutron_scraper(scrapy.Spider):
    ...
    def parse_products(self,response):
        baseurl ='https://www.hufriedygroup.com/'
        data_dict ={}
        ...
        images = response.css("li.easyzoom,easyzoom--overlay>a>img").css('::attr(src)').extract()
        images = [baseurl+image for image in images]
...
process.crawl(Accutron_scraper)
process.start()